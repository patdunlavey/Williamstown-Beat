  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <?php if ($title or $local_tasks or $tabs or $help or $messages): ?>
          <div id="content-header">
            ...
            <?php endif; ?>
            <?php if ($local_tasks): ?>
              <div class="tabs"><?php print $local_tasks; ?></div>
            <?php endif; ?>
            <?php print $help; ?>
          </div> <!-- /#content-header -->
        <?php endif; ?>
    ...
    <div id="footer"><div id="footer-inner" class="region region-footer">
      ...
      <?php print $footer; ?>
<!--      <div class="pp_icon"><a href="http://www.prosepoint.org" title="Powered by ProsePoint: Open source newspaper and magazine cms software"><img src="<?php print $base_path . $directory; ?>/prosepoint_icon.png" title="Powered by ProsePoint: Open source newspaper and magazine cms software" alt="Open source online newspaper and magazine cms software"></a></div>
-->
